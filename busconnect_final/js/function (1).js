...
//flip-card//
 document.getElementById('cardTrigger').addEventListener('click', function(e) {
    // Stops the click from triggering multiple layered actions
    e.stopPropagation(); 
  ...
  // Optional: If you want to click the back of the card to flip it back over
...
//flip-card end//
// Target by the unique data attribute instead of the shared ID
const bioTextarea = document.querySelector('[data-countdown="true"]');
...
function submitRegistration() {
  ...
  //first read the picture carefully 
  let fotoData = '';
  try {
  ...
  //after the registration went succesvol 
